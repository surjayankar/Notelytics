                ...
                <div className="max-w-6xl mx-auto px-4">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                            How It{" "}
                            <span className="bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 text-transparent bg-clip-text">Works</span>
                        </h2>    
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        <div className="text-center group">
                            ...
                            <p className="text-gray-400 text-lg leading-relaxed">
                                Link your Google Calendar and we'll automatically pull in your meetings.
                            </p>
                        ...
                        <div className="text-center group">
                            ...
                            <h3 className="text-2xl font-semibold text-white mb-4">
                                Let AI Join Your Meetings
                            </h3>
                            <p className="text-gray-400 text-lg leading-relaxed">
                                Our AI automatically joins and records your meetings with full transcriptions.
                            </p>
